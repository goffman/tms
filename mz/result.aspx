<%@ Page Language="C#" AutoEventWireup="true" CodeFile="result.aspx.cs" Inherits="admin_users_result" MasterPageFile="mz.master" Title="Аттестуемые"%>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="accordion" id="accordion2">
        <div class="accordion-group">
            ...
            <div id="collapseOne" class="accordion-body collapse" runat="server">

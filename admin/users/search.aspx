<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search.aspx.cs" Inherits="admin_users_search" Title="Поиск человека" MasterPageFile="../Admin.master" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
        <script>
            ...
            function ShowNotification(titile, mes) {
                ...
                notification.set_title(titile);
                notification.set_text(mes);
                notification.show();
            ...
            function openWin(index) {
                if (index === "spec") {
                    ...
                    wnd.setUrl("modal/changeSpecialty.aspx?id=" + IDAccountSelected.value);
                    wnd.set_title("Изменить специальность");
                    wnd.show();
                }
                else if (index === "edit")
                {
    ...
    <%--    <a href="modal/changeSpecialty.aspx">modal/changeSpecialty.aspx</a>--%>
    <telerik:RadAjaxPanel ID="RadAjaxPanel3" runat="server">
        <telerik:RadWindow ID="RadWindow1" OnClientClose="OnClientClose" runat="server" NavigateUrl="modal/changeSpecialty.aspx" Animation="Fade" AutoSize="True" MinHeight="500px" MinWidth="500px" Skin="Metro" Title="Информация о игре" ShowContentDuringLoad="False" VisibleStatusbar="True">
        </telerik:RadWindow>
        <telerik:RadNotification ID="RadNotification2" runat="server" Width="300" Height="120" Animation="Fade" Title="Notification Title" Text="dd"
   ...
   <%-- <div class="modal fade" id="RemoveResultTest" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index: -99999999">
    ...
    <%--    Метка "На удаление"--%>
    <div class="modal fade" id="BlackList" tabindex="-1" role="dialog" aria-labelledby="BlackList" aria-hidden="true" style="z-index: -99999999">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    ...
    <div class="alert alert-success" id="alert" runat="server" visible="False" style="z-index: 99999999">
    ...
    <asp:Panel ID="Panel1" runat="server">
        <div class="row-fluid">
            ...
            <div class="block">
                ...
                <div class="block-content collapse in">
                    <telerik:RadGrid ID="RadGrid1" runat="server" Culture="ru-RU" DataSourceID="SqlDataSource2" AllowSorting="True" AllowPaging="True" AllowMultiRowEdit="True" OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged" CellSpacing="-1" Skin="Bootstrap" RenderMode="Auto">
                        ...
                        <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDataSource2" ClientDataKeyNames="UserName,telefon,email,ID,F,I,O" GroupLoadMode="Client" NoMasterRecordsText="Нет записей">
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="on_delete" DataType="System.Int32" FilterControlAltText="Filter on_delete column" HeaderText="На удаление" SortExpression="on_delete" UniqueName="on_delete">
                                    <ColumnValidationSettings>
                                        <ModelErrorMessage Text="" />
                                    </ColumnValidationSettings>
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn DataField="status" DataType="System.Int32" FilterControlAltText="Filter status column" HeaderText="Статус" SortExpression="status" UniqueName="status">
                                    <ColumnValidationSettings>
                                        <ModelErrorMessage Text="" />
                                    </ColumnValidationSettings>
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="otpravlen" DataType="System.Int32" FilterControlAltText="Filter otpravlen column" HeaderText="Отправлен в МЗ" SortExpression="otpravlen" UniqueName="otpravlen">
                                    <ColumnValidationSettings>
                                        <ModelErrorMessage Text="" />
                                    </ColumnValidationSettings>
                                </telerik:GridBoundColumn>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:tmsConnectionString %>" SelectCommand="SELECT        [l-kabinet].ID, [l-kabinet].F, [l-kabinet].I, [l-kabinet].O, dolzhnost.dolzhnost, lpu.lpu, [l-kabinet].email, [l-kabinet].proba_test, [l-kabinet].telefon, 
                         [l-kabinet].on_delete, prohozhdenie_testa.rezultat, prohozhdenie_testa.data, prohozhdenie_testa.status, prohozhdenie_testa.otpravlen, 
                         ROUND(CONVERT(money, prohozhdenie_testa.rezultat) / 70 * 100, 0) AS Процент, users.UserName
    ...
    <div class="navbar">
        <div class="navbar-inner navbar-fixed-bottom">
            <ul class="nav">
                ...
                <li>
                    <asp:LinkButton ID="ChangeSpec" runat="server" OnClientClick="openWin('spec'); return false;"><i class="icon-briefcase"></i> Изменить специальность</asp:LinkButton>

                </li>
                <li>
                    <asp:LinkButton ID="EditAccount" runat="server" OnClientClick="openWin('edit'); return false;"><i class="icon-briefcase"></i> Изменить данные</asp:LinkButton>
